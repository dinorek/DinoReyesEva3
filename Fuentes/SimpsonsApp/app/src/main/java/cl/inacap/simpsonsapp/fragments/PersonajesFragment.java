package cl.inacap.simpsonsapp.fragments;
...
import cl.inacap.simpsonsapp.adapters.PersonajesAdapter;
...
public class PersonajesFragment extends Fragment {
    ...
    public void onResume() {
        ...
        JsonObjectRequest jsonReq = new JsonObjectRequest(Request.Method.GET, "https://thesimpsonsquoteapi.glitch.me/quotes", null, new Response.Listener<JSONObject>() {
            @Override
